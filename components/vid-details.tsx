         ...
         <div className="relative flex flex-col md:flex-row items-start gap-2 p-2 customBorder">
            ...
            <div className="flex flex-[0.35] flex-col items-start gap-1 w-full">
               ...
               <div className="flex w-full flex-wrap gap-1">
                  {activeVidFormats.map((vid: any, i: number) => (
                     <>
                        <ul className="flex flex-1 flex-row w-full items-center gap-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600">
                           <li
               ...
               <div className="md:absolute bottom-3 right-2">
                  ...
                  >
                     <button
                        className="flex items-center p-2 bg-black rounded-md text-gray-200 
                          shadow-md"
                        disabled={!downUrl}
                     >
