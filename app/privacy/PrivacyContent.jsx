...
const PrivacyContent = () => {
   return (
      <main className="flex flex-col flex-1 w-full md:w-2/3 lg:w-1/2">
         ...
         <div className="max-[768px]:text-sm text-gray-700">
            <p className="font-medium">Last updated: February 22, 2023</p>
            <br />
            <p>
            ...
            <br />
            <h1 className="font-semibold">Interpretation and Definitions</h1>
            <br />
            ...
            <br />
            <h2 className="font-medium">Definitions</h2>
            ...
            <ul className="">
               ...
               <li>
                  <p>
                     ...
                     Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                     &quot;Our&quot; in this Agreement) refers to VDOWN.
                  </p>
               </li>
               <li>
                  <p>
               ...
               <li>
                  <p>
                     <strong>Website</strong> refers to VDOWN, accessible from{" "}
                     <Link
                        href="https://vdown-eight.vercel.app/"
                        rel="external nofollow noopener"
                        target="_blank"
                     >
                        https://vdown-eight.vercel.app/
                     </Link>
                  </p>
               </li>
               <li>
            ...
            <h2 className="font-medium">Types of Data Collected:</h2>
            <br />
            ...
            <ul>
               <li>By email: ibraheemsani035@gmail.com</li>
            </ul>
         </div>
      </main>
   );
